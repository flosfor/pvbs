...
The use or modification of this software for a published work is permitted only upon agreement to cite the developer and the original source code (https://github.com/flosfor/pvbs).
